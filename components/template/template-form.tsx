                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Configura plantillas de mensajes para tus campañas
                            </p>
                        </div>
                    </div>
                </CardHeader>
                        ...
                        <div className={'col-span-4 grid grid-cols-2'}>
                                ...
                                {variablesText.map((variable) => (
                                    <div key={variable.id} className="space-y-2">
                                        <Label htmlFor={`variable-${variable.id}`}>
                                            Contenido de muestra para la variable {variable.placeholder}
                                        </Label>
                                        <Input
                                        ...
                                        {variablesMedia.map((variable) => (
                                            <div key={variable.id} className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    value={variable.sampleContent}
                                                    onChange={(e) =>
                                                        updateVariableMediaSample(variable.id, e.target.value)
                                                    }
                                                />
                                            </div>
                                        ))}
                            ...
                            <div className="space-y-4 col-span-1">
                                ...
                                <div className="relative mx-auto max-w-sm">
                                    ...
                                    {/* Phone Frame */}
                                    <div
                                        className="relative rounded-[2.5rem] border-[14px] border-gray-800 bg-gray-800 shadow-2xl">

                                        {/* Screen */}
                                        <div
                                            className="relative bg-white rounded-[1.5rem] overflow-hidden h-[600px] flex flex-col">
                                            {/* Status Bar */}
                                            <div
                                                className="bg-gradient-to-b from-gray-700 to-gray-800 px-6 py-4 flex items-center justify-center gap-2">
                                            ...
                                            {/* Message Content */}
                                            <div
                                                className="flex-1 p-6 bg-gradient-to-b from-gray-50 to-white overflow-auto">
                                                <div
                                                    className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                                                    {/* Media Placeholder */}
                                                    {selectedType === "media" && (
                                                        <div
                                                            className="aspect-video bg-gray-100 flex items-center justify-center text-muted-foreground border-b">
                                                            {mediaVariable2 ? (
                                                                <img
                                                                    src={mediaVariable2}
                                                                    alt="Media preview"
                                                    ...
                                                    <div className="p-4">
                                                        <p className="text-sm">
                                                            {replaceVariablesWithSamples(bodyText, variablesText) || bodyText}
                                                        </p>
                                                    </div>
                                                </div>

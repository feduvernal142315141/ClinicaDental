...
export const PATIENT_TABS_LIST_CLASS =
  "h-auto w-max gap-6 rounded-none border-0 border-b border-hairline bg-transparent p-0";
...
export const PATIENT_TAB_TRIGGER_CLASS =
  "-mb-px rounded-none border-b-2 border-transparent bg-transparent px-0 pb-2.5 pt-1 text-subtle shadow-none data-[state=active]:border-brand data-[state=active]:bg-transparent data-[state=active]:font-semibold data-[state=active]:text-brand data-[state=active]:shadow-none focus-visible:rounded-sm focus-visible:ring-2 focus-visible:ring-brand/30 focus-visible:ring-offset-2 focus-visible:ring-offset-canvas";
